...
RUN wget --progress=dot:giga https://github.com/FiloSottile/mkcert/releases/download/v1.4.1/mkcert-v1.4.1-linux-amd64 -O /usr/bin/mkcert && chmod +x /usr/bin/mkcert
RUN wget --progress=dot:giga https://amazon-eks.s3.us-west-2.amazonaws.com/1.18.9/2020-11-02/bin/linux/amd64/aws-iam-authenticator -O /usr/bin/aws-iam-authenticator && chmod +x /usr/bin/aws-iam-authenticator
