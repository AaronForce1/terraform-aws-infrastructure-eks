...
| <a name="provider_aws.secondary"></a> [aws.secondary](#provider\_aws.secondary) | ~> 4.5 |
...
| <a name="input_tech_email"></a> [tech\_email](#input\_tech\_email) | Tech Contact E-Mail for services such as LetsEncrypt | `any` | n/a | yes |
