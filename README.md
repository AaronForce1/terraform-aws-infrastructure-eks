...
| <a name="input_db_credentials"></a> [db\_credentials](#input\_db\_credentials) | postgres passwords for grafana google auth | <pre>list(object({<br>    name              = string<br>    namespace         = string<br>    labels            = optional(map(string))<br>    password          = string<br>    postgres-password = string<br>    type              = optional(string)<br>    secrets_store     = string<br>  }))</pre> | `[]` | no |
